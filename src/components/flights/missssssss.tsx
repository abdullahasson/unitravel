...
export default function HomeFlightsSearch() {
  ...
  return (
    <div className="flex-1 bg-yellow-500">
      <form onSubmit={handleSubmit} className="bg-white w-full shadow-2xl px-8 pb-8 pt-4 max-[767px]:p-6 border border-gray-100">
        {/* Trip Type Selector */}
          ...
          {(['one-way', 'return', 'round-trip'] as const).map((type) => (
            <button
              ...
              className={`py-2 px-4 text-center rounded-full text-sm transition-all duration-300 cursor-pointer ${formState.tripType === type
                ? 'bg-blue-600/50 shadow-md text-white font-medium'
        ...
        <div className="flex items-center gap-5 max-[767px]:gap-2 my-4">
          {/* Location Inputs */}
          <div className="flex-1 max-[767px]:flex-col relative flex items-center space-x-3">
