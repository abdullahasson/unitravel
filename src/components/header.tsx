...
const Header = ({ initialScrolled = false }: HeaderProps) => {
    ...
    return (
        <header className={`
            ...
            ${scrolled ? "bg-white shadow-md" : "backdrop-blur-md bg-transparent text-white"}
        `}>
                            ...
                            return (
                                <Link
                                    ...
                                    className={`
                                        nav-link 
                                        ${false ? "active" : ""}
                                        ${scrolled ? "text-darker" : "text-white"}
                                        relative py-2 font-medium text-lg transition-all duration-400
                                    `}
                                >
                                    {link.label}
                                </Link>
