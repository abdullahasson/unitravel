            ...
            <div className="search-section bg-white rounded-2xl p-6 md:p-10 -mt-28 mb-16 max-w-6xl mx-auto shadow-card relative z-30 opacity-0 translate-y-4 animate-fadeInUp" style={{ animationDelay: '0.8s' }}>
                ...
                <form className="search-form grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-5">
                    <div className="form-group relative">
                        <PlaneTakeoff className="form-icon absolute top-1/2 right-5 -translate-y-1/2 text-gray-400" />
                    ...
                    <div className="form-group relative">
                        <PlaneLanding className="form-icon absolute top-1/2 right-5 -translate-y-1/2 text-gray-400" />
                    ...
                    <div className="form-group relative">
                        <Calendar className="form-icon absolute top-1/2 right-5 -translate-y-1/2 text-gray-400" />
                    ...
                    <div className="form-group relative">
                        <User className="form-icon absolute top-1/2 right-5 -translate-y-1/2 text-gray-400" />
