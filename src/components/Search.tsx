            ...
            <div className="flex justify-center gap-5 mb-8 opacity-0 translate-y-5 animate-fadeInUp" style={{ animationDelay: '0.6s' }}>
                <button
                    ...
                    className={`
                            ...
                            ${false ? "btn-[var(--color-primary)] bg-linear-0 from-[var(--color-primary)] to-[var(--color-secondary)] text-white py-3 px-8 rounded-full font-semibold shadow-md shadow-blue-500/20" : ""}
                        `}
                >
                    {t("JoinPartner")}
                </button>
